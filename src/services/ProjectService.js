...
const createCurrentProject = () => ({
  ...
  status: "active",
  experiences: [
    { id: "cubierta-01", name: "CUBIERTA 01", icon: "FaShip", startScene: "insideOne", description: "Cubierta 01" },
    { id: "cubierta-proa", name: "CUBIERTA DE PROA", icon: "FaAnchor", startScene: "insideFour", description: "Cubierta de Proa" },
    { id: "cubierta-popa", name: "CUBIERTA DE POPA", icon: "FaCog", startScene: "insideThirteen", description: "Cubierta de Popa" },
    { id: "cubierta-principal", name: "CUBIERTA PRINCIPAL", icon: "FaWater", startScene: "insideSix", description: "Cubierta Principal" },
  ],
  scenes: dataScene,
