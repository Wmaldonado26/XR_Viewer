        ...
        <section className="landing-stack-section w-full relative">
          ...
          <div className="w-full">
            <div className="landing-stack-cards" style={{ "--numcards": (stackingCards.length + 1) || 1 }}>
              ...
              <div
                className="landing-stack-card group cursor-pointer"
                style={{ "--index0": stackingCards.length, "--index": stackingCards.length + 1 }}
              >
                <div className="landing-stack-card-content landing-stack-card-content--tour">
                  <div
                    className="landing-stack-card-media landing-stack-card-media--tour"
                    onClick={() => navigate("/public-tour/businu/bridge")}
                  >
                    <img
                      src={stackingCards[0]?.image || '/images/default_image.png'}
                      alt="Recorrido 360"
                      className="w-full h-full object-cover"
                    />
                    <div className="landing-stack-card-media-overlay">
                      <span>360</span>
                    </div>
                  </div>
                </div>
